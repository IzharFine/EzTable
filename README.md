...
1. New row object.<br />
2. Table Name.<br />
* Pay attention that the new row ID is 0 by default, you probebly will have change it and set the new row ID you got from the server for instant Update/Delete functions.<br />
